// Signup.jsx — tela publica de cadastro de nova empresa (tenant).
//
// Acessada via link "Criar empresa" no Login.jsx. Apos signup bem-sucedido,
...
export default function Signup({ onSuccess, onVoltarLogin }) {
  ...
  function showErr(campo, condicao) {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      setStatus('error');
      setErr(e2?.message || 'Nao foi possivel criar a empresa.');
    }
  };
