    ...
    <>
      <style>{`
        ...
        .lux-eyebrow {
          ...
          color: ${C.muted}; margin: 0 6px 14px;
        }
        .lux-eyebrow .dot {
        ...
        .lux-head {
          ...
          gap: 16px; padding: clamp(20px, 3.4vw, 30px) clamp(20px, 3.4vw, 34px) 0;
          flex-shrink: 0;
        }
        .lux-title {
          margin: 0;
        ...
        .lux-body {
          padding: 22px clamp(20px, 3.4vw, 34px) 0;
        ...
        .lux-row { display: grid; gap: 14px; grid-template-columns: 1fr 1fr; }
        ...
        .lux-input, .lux-select, .lux-textarea {
          ...
          padding: 12px 14px; font: inherit; font-size: 14px; line-height: 1.4;
        ...
        .lux-textarea { resize: vertical; min-height: 96px; max-height: 280px; line-height: 1.5; }

        .lux-foot {
          display: flex; align-items: center; justify-content: space-between;
          gap: 14px;
          padding: 16px clamp(20px, 3.4vw, 34px) clamp(20px, 3.4vw, 28px);
        ...
        .lux-btn {
          ...
          padding: 11px 18px; border-radius: 10px; transition: all .18s ease;
          letter-spacing: .005em; font-size: 13.5px;
        ...
        @media (max-width: 720px) {
          ...
          .lux-foot__note { justify-content: center; }
      ...
      <div className="lux-overlay" onClick={() => !salvando && onFechar?.()}>
        <div className="lux-stage" onClick={e => e.stopPropagation()}>
          ...
          <section className="lux-card" style={estiloCard} role="dialog" aria-modal="true">
            ...
            <form className="lux-body" onSubmit={onSubmit} noValidate autoComplete="on">
              {children}
